...
CREATE TABLE 'Message' (
    ...
    FOREIGN KEY ('vUser') REFERENCES 'Company_profile' ('cUser') ON DELETE CASCADE ON UPDATE CASCADE,
...
('gbgw123', 1, 'Important Update', 'Time of cleanup has changed!', '2023-04-10'),
('gbgw123', 1, 'Change of plans', 'We have changed the location', '2023-04-10');
